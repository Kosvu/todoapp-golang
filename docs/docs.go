...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_Kosvu_todoapp-golang_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
    ...
    "definitions": {
        "github_com_Kosvu_todoapp-golang_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "internal_features_users_transport_http.CreateUserRequest": {
            ...
            "properties": {
                ...
                "phone_number": {
                    "description": "omitempty значит только в случае если PhoneNumber есть",
                    "type": "string",
                    "maxLength": 15,
                    "minLength": 10,
                    "example": "+79998887766"
